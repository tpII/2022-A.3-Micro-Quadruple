...
std::array<double, 16> MIN_ALLOWED = {0,
                                    BR1_OFFSET-10, BR2_OFFSET-50, BR3_OFFSET-75,
                                    0,
                                    FL1_OFFSET-10, FL2_OFFSET-50, FL3_OFFSET-75,
                                    0,
                                    FR1_OFFSET-45, FR2_OFFSET-15, FR3_OFFSET-75,
                                    0,
                                    BL1_OFFSET-45, BL2_OFFSET-15, BL3_OFFSET-75
                                    };
std::array<double, 16> MAX_ALLOWED = {0,
                                    BR1_OFFSET+45, BR2_OFFSET+15, BR3_OFFSET+75,
                                    0,
                                    FL1_OFFSET+45, FL2_OFFSET+15, FL3_OFFSET+75,
                                    0,
                                    FR1_OFFSET+10, FR2_OFFSET+50, FR3_OFFSET+75,
                                    0,
                                    BL1_OFFSET+10, BL2_OFFSET+50, BL3_OFFSET+75
                                    };
...
bool isValidAngle(int servoId, int angle){
    return angle >= MIN_ALLOWED[servoId] && angle <= MAX_ALLOWED[servoId];
}
...
namespace QuadLibrary
{
    ...
    void Quad::setServo(int servoId, int degree)
    {
        ...
        Serial.print("to: ");
        Serial.print(clamp(servoId,degree));
        Serial.print(" - Value without Clamp: ");
